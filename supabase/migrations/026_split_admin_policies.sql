...
drop policy if exists aikeys_admin_insert on public.ai_provider_keys;
create policy aikeys_admin_insert on public.ai_provider_keys for insert to authenticated with check (is_platform_admin());
drop policy if exists aikeys_admin_update on public.ai_provider_keys;
...
drop policy if exists aikeys_admin_delete on public.ai_provider_keys;
...
drop policy if exists aisettings_admin_insert on public.ai_settings;
create policy aisettings_admin_insert on public.ai_settings for insert to authenticated with check (is_platform_admin());
drop policy if exists aisettings_admin_update on public.ai_settings;
...
drop policy if exists aisettings_admin_delete on public.ai_settings;
...
drop policy if exists padmin_insert on public.platform_admins;
create policy padmin_insert on public.platform_admins for insert to authenticated with check (is_platform_admin());
drop policy if exists padmin_update on public.platform_admins;
...
drop policy if exists padmin_delete on public.platform_admins;
