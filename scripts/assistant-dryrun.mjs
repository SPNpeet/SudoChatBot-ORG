...
const CASES = [
  ...
  // ---- 2 tool ที่ไม่เคยมีเคสวัดเลย (9 ส.ค. 2569) ----
  // ⚠️ ทั้งคู่ทดสอบ "ของจริงทั้งเส้น" ไม่ได้ด้วยเครื่องมือฝั่งเรา:
  //   run_depreciation ต้องมีทรัพย์สินที่ได้มาก่อนเดือนที่จะลง และเดือนนั้นต้องจบแล้ว
  //   approve_expense ต้องมีพนักงาน (role agent) ส่งค่าใช้จ่ายเข้ามารออนุมัติจริง
  // แต่ครึ่งที่วัดได้แน่ ๆ คือ "โมเดลรู้ไหมว่ามี tool นี้อยู่" ซึ่งเป็นครึ่งที่พังบ่อยกว่า
  // (tool พังจะมี error ให้เห็น แต่ tool ที่ไม่เคยถูกเลือกจะเงียบสนิท)
  { ชื่อ: "ลงค่าเสื่อมราคาประจำเดือน", ถาม: "ปิดเดือนกรกฎาคมแล้ว ลงค่าเสื่อมราคาของเดือนกรกฎาคมให้หน่อย",
    ต้องเรียก: ["run_depreciation"] },
  { ชื่อ: "อนุมัติค่าใช้จ่ายที่พนักงานส่งมา", ถาม: "ค่าใช้จ่าย EXP-2026-0007 ที่พนักงานส่งมารออนุมัติ อนุมัติให้เลย",
    ต้องเรียก: ["approve_expense"] },
];
