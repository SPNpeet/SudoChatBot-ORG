"use client";
// ============================================================
//  แพ็กเกจและเครดิต — จ่ายผ่าน Stripe ทางเดียว
//
        ...
        <CardContent>
          {!gatewayReady && (
            <div className="mb-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
              {/* คนอ่านแบนเนอร์นี้คือ "ลูกค้าที่อยากจ่ายวันนี้" — ต้องมีทางไปต่อจริง ไม่ใช่ทางตัน
                  แอดมินเปิดแพ็กให้มือได้อยู่แล้ว (หน้าแอดมิน) จึงขายได้ก่อนเปิดจ่ายออนไลน์ */}
              ช่องทางจ่ายออนไลน์กำลังเปิดใช้ — อยากเริ่มแพ็กตอนนี้เลย{" "}
              <a href="/contact" className="inline-flex min-h-11 items-center font-semibold underline">ติดต่อเราที่นี่</a>{" "}
              ทีมงานเปิดแพ็กให้ได้ภายในวันเดียวกัน
            </div>
          )}
