...
export default function QuickCreate() {
  ...
  // ⚠️ หน้าภาพรวมไม่ต้องมีปุ่มลอยแล้ว (แก้ 5 ก.ย. 2569)
  // ตั้งแต่ย้ายปุ่ม "ออกบิล/ใบเสร็จ" กับ "ถ่ายรูปบิล" ขึ้นมาไว้ในจอแรก (command-bar.tsx)
  // ปุ่มลอยบนหน้านี้กลายเป็นทางที่สองไปที่เดียวกัน = ผู้ใช้ต้องเลือกว่าจะกดอันไหน
  // และภาพจริงบนมือถือ: มันลอยทับตัวเลข "ลูกหนี้ค้างรับ 10,700" จนอ่านไม่ครบ
  // (อาการเดียวกับที่เจ้าของเคยแคปมาเมื่อ 29 ส.ค. — padding/หลบตอนเลื่อน แก้ตอนจอนิ่งไม่ได้)
