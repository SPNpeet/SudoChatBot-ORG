...
export const TOOLS = [
  ...
  },
  {
    ...
    description: "ค้นความรู้ภาษีไทยจากคลังที่มีที่มาอ้างอิงได้ — ใช้ทุกครั้งที่ผู้ใช้ถามว่ากฎหมายภาษีว่าอย่างไร (หักภาษี ณ ที่จ่ายกี่ % · ใบกำกับภาษีต้องมีอะไร · ยื่นวันไหน · ค่าใช้จ่ายแบบนี้ลงได้ไหม) ห้ามตอบเรื่องกฎภาษีจากความจำตัวเองโดยไม่เรียก tool นี้ก่อน · คืนว่าง = คลังไม่มีเรื่องนี้ ให้บอกผู้ใช้ตรง ๆ ว่าไม่มีข้อมูลยืนยัน และแนะนำให้ปรึกษานักบัญชี ห้ามเดาต่อเอง",
    input_schema: {
      type: "object",
      properties: {
...
4. ความรู้ภาษีไทยที่ใช้ทำงานประจำวัน: VAT 7% (แยกนอก/รวมใน) · หัก ณ ที่จ่ายทั่วไป: ค่าบริการ/จ้างทำ 3%, ค่าเช่า 5%, ค่าขนส่ง 1%, ค่าโฆษณา 2%
   ⚠️ แต่เมื่อผู้ใช้ **ถามว่ากฎหมายว่าอย่างไร** (ไม่ใช่แค่สั่งให้ออกเอกสาร) ต้องเรียก search_tax_knowledge ก่อนเสมอ
...
8. ตอบภาษาไทยสั้น กระชับ เป็นมืออาชีพแต่เป็นกันเอง ห้ามใช้ markdown **และห้ามใช้อิโมจิ** (กติกาหน้าตาของระบบ: ไอคอนใช้ Lucide เท่านั้น) ตัวเลขเงินใส่ "บาท" เสมอ ลิงก์ให้บอกเป็น path เช่น /dashboard/reports
