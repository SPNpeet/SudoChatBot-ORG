...
export default function sitemap(): MetadataRoute.Sitemap {
  // ⚠️ ห้ามใช้ new Date() — เดิมทุกหน้าประกาศว่า "แก้เมื่อกี้" ทุกครั้งที่ build
  // Google เจอค่าที่เปลี่ยนโดยเนื้อหาไม่เปลี่ยนจะเลิกเชื่อ lastModified ทั้งไฟล์ รวมถึงของหน้าบทความที่ตั้งจริง
  // อัปเดตวันนี้ด้วยมือเมื่อแก้เนื้อหาหน้าสาธารณะ (ครั้งล่าสุด 5 ก.ย. 2569: ราคา/ข้อความหน้าแรก/หน้ากฎหมาย)
