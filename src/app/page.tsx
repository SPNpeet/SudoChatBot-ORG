...
const plans = [
  ...
  { name: "ธุรกิจ", price: "249", per: "บาท/เดือน", items: ["สูงสุด 3 กิจการ · พนักงานไม่จำกัด", "สมุดรายวัน + 50 ทวิ + AI อ่านบิล", "ตรวจสลิปอัตโนมัติ 300 สลิป/เดือน", "งาน AI 400 คำสั่ง/เดือน — ราคาเท่าเจ้าตลาด ได้ AI ที่เขาไม่มี"], cta: "เลือกแพ็กนี้", hot: true },
