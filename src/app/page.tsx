...
const plans = [
  { name: "เริ่มต้น", price: "99", per: "บาท/เดือน", items: ["1 กิจการ · พนักงานไม่จำกัด", "เอกสาร/บัญชี/ภาษี ครบ คีย์เองไม่จำกัด", "ตรวจสลิปอัตโนมัติ 100 สลิป/เดือน", "งาน AI 100 คำสั่ง/เดือน"], cta: "เริ่มเลย", hot: false },
  { name: "ธุรกิจ", price: "199", per: "บาท/เดือน", items: ["สูงสุด 3 กิจการ · พนักงานไม่จำกัด", "สมุดรายวัน + 50 ทวิ + AI อ่านบิล", "ตรวจสลิปอัตโนมัติ 200 สลิป/เดือน", "งาน AI 400 คำสั่ง/เดือน — ถูกกว่าเจ้าตลาด และได้ AI ที่เขาไม่มี"], cta: "เลือกแพ็กนี้", hot: true },
  { name: "สำนักงานบัญชี", price: "499", per: "บาท/เดือน", items: ["สูงสุด 10 กิจการ · พนักงานไม่จำกัด", "ไฟล์ยื่นสรรพากร ภ.พ.30 / ภ.ง.ด. (.txt)", "ตรวจสลิปอัตโนมัติ 500 สลิป/เดือน", "งาน AI 1,000 คำสั่ง/เดือน"], cta: "เลือกแพ็กนี้", hot: false },
  { name: "สำนักงานบัญชีใหญ่", price: "999", per: "บาท/เดือน", items: ["ไม่จำกัดจำนวนกิจการ", "ทุกอย่างในสำนักงานบัญชี", "ตรวจสลิปอัตโนมัติไม่จำกัด", "งาน AI 3,000 คำสั่ง/เดือน"], cta: "เลือกแพ็กนี้", hot: false },
];
