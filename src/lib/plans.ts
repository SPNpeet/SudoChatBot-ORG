...
const FALLBACK: PublicPlan[] = [
  ...
  { code: "executive", name: PLAN_NAME_TH.executive, price: "1,290", yearly: "12,900", items: ["สูงสุด 15 กิจการ", "ทุกอย่างในธุรกิจ + ไฟล์ยื่นสรรพากร ภ.พ.30 / ภ.ง.ด. (.txt)", "เครดิต AI 5,000/เดือน", "ตรวจสลิปอัตโนมัติ 2,000 สลิป/เดือน", "ประวัติการทำรายการครบทุกรายการ ตรวจย้อนหลังได้"], hot: false, free: false },
  { code: "agency", name: PLAN_NAME_TH.agency, price: "2,990", yearly: "29,900", items: ["ไม่จำกัดจำนวนกิจการ", "ทุกอย่างในสำนักงานบัญชี", "เครดิต AI 15,000/เดือน", "ตรวจสลิปอัตโนมัติไม่จำกัด", "แยกข้อมูลแต่ละลูกค้าเด็ดขาด + ดูแลเฉพาะทาง"], hot: false, free: false },
];
