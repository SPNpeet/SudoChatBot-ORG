...
2. **ทดสอบ end-to-end บน production**: ตั้งกิจการ → ออก INV → ลิงก์ลูกค้า → สลิป → ดูสมุดรายวัน/รายงาน (สมัครสมาชิกทดสอบผ่านแล้วรอบหก) + ทดสอบ approval flow ด้วยบัญชี agent จริง
