> # ⛔ ไฟล์นี้เลิกใช้แล้ว — อ่าน `CLAUDE.md` แทน
>
> เนื้อหาด้านล่างเป็นของยุคก่อน pivot (30 ก.ค. 2569) ตอนที่ระบบยังเป็น
> "แชทบอท AI ปิดการขายบน Facebook/Instagram/LINE" ซึ่ง**ไม่มีอยู่แล้ว**
>
> ที่ผิดจากความจริงตอนนี้: โค้ดไม่ได้อยู่ `C:\SudoChatBot` · Edge Functions 5 ตัวถูกลบหมดแล้ว ·
> ไม่มี `skill/sudochatbot-dev/SKILL.md` · งานค้างในนี้เสร็จไปนานแล้ว
>
> เก็บไว้เป็นบันทึกประวัติเท่านั้น **ห้ามใช้อ้างอิงในการทำงาน**
